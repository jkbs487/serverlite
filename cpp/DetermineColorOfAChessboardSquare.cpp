// Source : https://leetcode-cn.com/problems/determine-color-of-a-chessboard-square/
// Author : jkbs487
// Date   : 2021-04-05
...
//Using ACSII and ^ to calculate
//only one is odd number another even number is true
class Solution {
public:
