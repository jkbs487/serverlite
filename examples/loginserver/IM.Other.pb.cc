...
const uint32_t TableStruct_IM_2eOther_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_IM_2eOther_2eproto = {
  false, false, 68, descriptor_table_protodef_IM_2eOther_2eproto, "IM.Other.proto", 
